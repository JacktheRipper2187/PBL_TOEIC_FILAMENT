            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item"><a class="nav-link py-3 px-0 px-lg-3 rounded"
                            href="{{ url('/beranda') }}">{{ __('messages.home') }}</a></li>
                    <li class="nav-item"><a class="nav-link py-3 px-0 px-lg-3 rounded"
                            href="{{ url('/syarat') }}">{{ __('messages.terms') }}</a></li>
                    <li class="nav-item"><a class="nav-link py-3 px-0 px-lg-3 rounded"
                            href="{{ url('/pendaftaran') }}">{{ __('messages.registration') }}</a></li>
                    <li class="nav-item"><a class="nav-link py-3 px-0 px-lg-3 rounded"
                            href="{{ url('/jadwal') }}">{{ __('messages.schedule') }}</a></li>
                    <li class="nav-item"><a class="nav-link py-3 px-0 px-lg-3 rounded"
                            href="{{ url('/hasil') }}">{{ __('messages.result') }}</a></li>
